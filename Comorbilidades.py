from Sacar_Distancias import *


class Comorbilidades:
    ...
    def proceso(self):
        #Sacar distancias
        dista= Sacar_Distancias(self.tabla)
        dista.hacer_calculo()
        self.lista_dis_euclidianas = dista.lista_dis_euclidianas
...
comor = Comorbilidades(tabla)
comor.proceso()
comor.imprimir_resultados()